...
\begin{itemize}
\item Researchers can use bike sharing systems  as a sensor network, which can be used for studying mobility in a city \textcolor{orange}{one student} \textcolor{orange}{distinctive} from others.
